...
ratings =pd.read_csv(r"C:\Users\sandh\Downloads\archive (9)\ml-latest-small\ratings.csv")
movies = pd.read_csv(r"C:\Users\sandh\Downloads\archive (9)\ml-latest-small\movies.csv")
